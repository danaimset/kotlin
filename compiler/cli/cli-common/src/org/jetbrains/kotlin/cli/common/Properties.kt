...
enum class CompilerSystemProperties(val property: String, val defaultValue: String? = null) {
    ...
    var value
        ...
        set(value) {
//            if (this == KOTLIN_COMPILER_ENVIRONMENT_KEEPALIVE_PROPERTY) {
//                println("SET KEEPALIVE $value")
//                val elements = Thread.currentThread().stackTrace
//                for (i in 1 until elements.size) {
//                    val s = elements[i]
//                    println("\tat " + s.className + "." + s.methodName + "(" + s.fileName + ":" + s.lineNumber + ")")
//                }
//            }
...
val lineSeparator: String
    get() = (if (isWindows) LineSeparator.CRLF else LineSeparator.LF).separatorString
